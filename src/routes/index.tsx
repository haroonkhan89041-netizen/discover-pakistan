...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { property: "og:site_name", content: "Discover Pakistan" },
      { property: "og:locale", content: "en_US" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Discover Pakistan | An Extraordinary Journey" },
      { name: "twitter:description", content: "Breathtaking landscapes, timeless heritage and unforgettable hospitality." },
    ],
  }),
